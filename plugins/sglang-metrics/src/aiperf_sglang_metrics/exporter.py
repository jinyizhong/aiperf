...
"""Opt-in deferred exporter for the 0.12/0.13 AIPerf protocol."""
...
class SGLangMetricsExporter:
    """Consume completed models, not concurrently-written native artifact files."""
    is_deferred = True
    ...
    def get_export_info(self) -> FileExportInfo:
        """Advertise the additional report without changing native exports."""
    ...
    async def export(self) -> None:
        """Use only the shared exporter contract; optional phase fields may be absent."""
        ...
        try:
            source["_aiperf_version"] = version("aiperf")
        except PackageNotFoundError:
            source["_aiperf_version"] = "unknown"
